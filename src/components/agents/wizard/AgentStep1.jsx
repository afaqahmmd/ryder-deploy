...
import { RiInformationLine, RiUserSmileLine, RiArrowDownSLine, RiSearchLine, RiCloseLine } from 'react-icons/ri'
import { getAllCountries, getAccentsForCountry, getGeneralAccentForCountry, getDescriptionForCountry } from '../../../utils/countryAccentData'
...
const AgentStep1 = ({ data, onUpdate }) => {
  ...
  const communicationStyles = [
    { value: 'friendly', label: 'Friendly', description: 'Warm and approachable, great for building relationships' },
    { value: 'professional', label: 'Professional', description: 'Formal and business-like, perfect for B2B sales' },
    { value: 'casual', label: 'Casual', description: 'Relaxed and informal, ideal for younger customers' },
    { value: 'formal', label: 'Formal', description: 'Polite and structured, suitable for luxury products' },
    { value: 'enthusiastic', label: 'Enthusiastic', description: 'Energetic and positive, great for exciting products' },
    { value: 'calm', label: 'Calm', description: 'Peaceful and reassuring, perfect for sensitive purchases' },
    { value: 'authoritative', label: 'Authoritative', description: 'Confident and knowledgeable, ideal for expert advice' },
    { value: 'empathetic', label: 'Empathetic', description: 'Understanding and compassionate, great for personal products' },
    { value: 'playful', label: 'Playful', description: 'Fun and engaging, perfect for creative brands' },
    { value: 'serious', label: 'Serious', description: 'Focused and straightforward, suitable for important decisions' }
  ]
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Let's create your ideal salesperson by defining their personality, communication style, and characteristics.
        </p>
      </div>
      ...
      <form className="space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-2">
                <label htmlFor="salesperson-name" className="block text-sm font-medium text-gray-700">
              ...
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  <span className="font-medium">💡 Pro Tip:</span> Choose a friendly, memorable name that your customers will feel comfortable talking to. Think of it like naming a new team member!
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <label htmlFor="salesperson-age" className="block text-sm font-medium text-gray-700">
              ...
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  <span className="font-medium">💡 Pro Tip:</span> Consider your target audience - a younger salesperson might relate better to younger customers, while an experienced one might build more trust with older customers.
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <label htmlFor="salesperson-gender" className="block text-sm font-medium text-gray-700">
              ...
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  <span className="font-medium">💡 Pro Tip:</span> This helps your salesperson communicate in a way that feels natural and relatable to your customers.
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <label htmlFor="salesperson-country" className="block text-sm font-medium text-gray-700">
              ...
              <div className="relative country-dropdown-container">
                ...
                >
                  ...
                  <RiArrowDownSLine className={`w-4 h-4 text-gray-400 transform transition-transform ${showCountryDropdown ? 'rotate-180' : ''}`} />
                </button>
              ...
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  <span className="font-medium">💡 Pro Tip:</span> Choose a country that matches your target audience or brand voice for better connection and relatability. For instance, if your brand focuses on Japanese items, you might want to select Japan.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Personality Section */}
        <div className="bg-gray-50 p-6 rounded-lg">
          <h4 className="text-lg font-medium text-gray-900 mb-4">Personality & Communication Style</h4>
          ...
          <div className="mb-6">
            ...
            <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                <span className="font-medium">💡 Pro Tip:</span> Choose top 3 traits that will help your salesperson connect with your customers and represent your brand effectively. Think about what makes a great salesperson in your industry!
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <label htmlFor="communication-style" className="block text-sm font-medium text-gray-700">
            ...
            <div className="mt-3">
              <p className="text-sm font-medium text-gray-700 mb-2">Popular communication styles:</p>
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                <span className="font-medium">💡 Pro Tip:</span> Choose a communication style that matches your brand personality and target audience for consistent customer experience.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <label htmlFor="behavior-prompt" className="block text-sm font-medium text-gray-700">
            ...
            {showTemplates && (
              <div className="mb-4 p-4 bg-white border border-gray-200 rounded-lg">
                <h5 className="text-sm font-medium text-gray-900 mb-3">Choose a behavior template:</h5>
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  {behaviorPromptTemplates.map((template, index) => (
                    <div
                      key={index}
                      className="behavior-template-container"
                    >
                      <button
                        type="button"
            ...
            <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                <span className="font-medium">💡 Pro Tip:</span> This is where you define the specific behaviors and approaches your salesperson should use during customer interactions. Think about your ideal sales process and how you want them to handle different scenarios!
              </p>
            </div>
          </div>
        </div>

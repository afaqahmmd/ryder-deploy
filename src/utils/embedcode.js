...
//         <div class="border-t border-gray-200 p-3 relative">
...
//                 class="absolute right-0 bottom-10 bg-white border border-gray-200 rounded-lg shadow-md hidden z-10">
//                 <button id="clear-chat-btn" class="block w-full text-left px-4 py-2 text-sm hover:bg-gray-100 text-gray-700">
//                   🧹 Clear Chat
//                 </button>
//               </div>
//             </div>
...
//           <!-- Toast -->
//           <div id="toast"
//             class="hidden absolute bottom-16 right-4 bg-green-600 text-white text-sm px-3 py-2 rounded-lg shadow-md">
...
//         const messageDiv = document.createElement("div");
//         messageDiv.className = \`flex w-full break-words overflow-auto \${message.sender === "user" ? "justify-end" : "justify-start"}\`;
//         const bubbleClass = message.sender === "user" ? "bg-blue-600 text-white rounded-br-none" : "bg-gray-100 text-gray-800 rounded-bl-none";
//         const timeClass = message.sender === "user" ? "text-blue-100" : "text-gray-500";
...
//         const { messagesContainer, toast, menuDropdown } = getDOMElements();
//         chatState.messages = [];
//         messagesContainer.innerHTML = "";
//         localStorage.removeItem("chatbot_customer_id");
...
//       const bindEvents = () => {
//         const { chatToggle, closeChat: closeBtn, sendButton, messageInput, menuButton, menuDropdown, clearChatBtn } = getDOMElements();
...
//         if (storedConversationId) await loadConversationHistory(storedConversationId);
//         if (storedCustomerId) {
//           payload.customer_id = storedCustomerId;
//           payload.new_convo = false;
//           trackingData.chatbot_customer_id = storedCustomerId;
